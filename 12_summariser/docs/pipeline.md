...
2. Оставьте переключатель `Meta Files` выключенным, чтобы исключить вступления, представления, вопросы, организационные разделы и страницы только с заголовком. Включите его, чтобы сохранить все страницы.
