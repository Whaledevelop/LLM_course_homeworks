...
class ContentFilterService:
    ...
    def _get_page_type(
        ...
        prompt = f"""
Определи тип страницы PDF для итогового Markdown по теме документа.

Название документа: {document_title}

CONTENT — страница с фактами, аргументами, определениями, методами, примерами, результатами или выводами, которые прямо раскрывают тему документа.
HEADER — страница только с тематическим заголовком, который начинает или разделяет раздел документа. Это не служебная страница; её нужно сохранить как Markdown-заголовок без номера страницы.
META — титульный слайд документа, приветствие, представление людей, программа, организационное объявление, вопросы аудитории, благодарность, контакты, ссылка, информация о спикере, реклама или иной служебный материал.
