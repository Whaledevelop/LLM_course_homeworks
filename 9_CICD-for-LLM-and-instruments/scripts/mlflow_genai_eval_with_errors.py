...
def main():
    ...
    eval_data.loc[1, "predictions"] = "The capital of England is Paris."
    ...
    with mlflow.start_run(
            run_name="qwen-local-genai-judge-with-errors"
    ):
        mlflow.log_param("model", MODEL_NAME)
        mlflow.log_param("base_url", BASE_URL)
        mlflow.log_param("judge_metric", "make_genai_metric")
        mlflow.log_param("contains_intentional_error", True)
